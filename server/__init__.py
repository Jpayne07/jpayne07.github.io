...
def create_app(test_config=None):
    ...
    # )
    CORS(app, supports_credentials=True, origins=["https://api.jacobpaynecodes.com/", "http://localhost:3000"], methods=["GET", "POST", "PATCH", "DELETE", "OPTIONS"], allow_headers=["Content-Type", "Authorization", "X-Requested-With"])
